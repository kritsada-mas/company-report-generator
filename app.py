...
# form to create a new report in the main column
...
# form to query an existing report in the main column
...
with st.sidebar:
    ...
    # Add content to the side panel as needed
    st.text("This is the side panel content.")
